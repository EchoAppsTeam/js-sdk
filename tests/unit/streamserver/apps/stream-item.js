Echo.Tests.Units.push(function(callback) {
	...
	var suite = Echo.Tests.Unit.Item = function() {
		this.constructRenderersTest({
			"instance": {
				"name": "Echo.StreamServer.BundledApps.Stream.Item.ClientWidget",
				"config": {
	...
	suite.prototype.info = {
		"className": "Echo.StreamServer.BundledApps.Stream.Item.ClientWidget",
		"functions": [
			"isRoot",
			"block",
			"unblock",
	...
	suite.prototype.cases.traverse = function(callback) {
		var item = suite.item;
		item.events.subscribe({
			"topic": "Echo.StreamServer.BundledApps.Stream.Item.ClientWidget.onRerender",
			"once": true,
			"handler": function() {
				var content = "";
	...
	suite.prototype.cases.expand = function(callback) {
		var item = suite.item;
		item.events.subscribe({
			"topic": "Echo.StreamServer.BundledApps.Stream.Item.ClientWidget.onChildrenExpand",
			"once": true,
			"handler": function() {
	...
	suite.prototype.cases.click = function(callback) {
		...
		item.events.subscribe({
			"topic": "Echo.StreamServer.BundledApps.Stream.Item.ClientWidget.onButtonClick",
			"once": true,
		...
		"check": function() {
			...
			this._runBodyCases([{
				...
				"data": {
					...
					"expect": '1 <img class="echo-streamserver-bundledapps-stream-item-clientwidget-smiley-icon" src="' + Echo.require.toUrl("echo-assets/images/smileys/emoticon_smile.png", false) + '" title="Smile" alt="Smile"> <b>$$<u>DD</u>$$<i>#88</i></b> 5#\n<a href="http://">#asd</a>\n<a href="http://ya.ru">http://ya.ru</a>\n\n\n<a href="http://google.com/#qwerty">http://google.com/#qwerty</a>'
			}, {
				...
				"expect": '1 :) <b>$$<u>DD</u>$$<i><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">88</span></i></b> 5#\n<a href="http://"><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">asd</span></a>\n<a href="http://ya.ru">http://ya.ru</a>\n\n\nhttp://google.com/#qwerty'
			}, {
				...
				"expect": '1 <img class="echo-streamserver-bundledapps-stream-item-clientwidget-smiley-icon" src="' + Echo.require.toUrl("echo-assets/images/smileys/emoticon_smile.png", false) + '" title="Smile" alt="Smile"> <b>$$<u>DD</u>$$<i><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">88</span></i></b> 5#\n<a href="http://"><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">asd</span></a>\n<a href="http://ya.ru">http://ya.ru</a>\n\n\nhttp://google.com/#qwerty'
			}, {
				...
				"expect": '1 <img class="echo-streamserver-bundledapps-stream-item-clientwidget-smiley-icon" src="' + Echo.require.toUrl("echo-assets/images/smileys/emoticon_smile.png", false) + '" title="Smile" alt="Smile"> <b>$$<u>DD</u>$$<i><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">88</span></i></b> 5#&nbsp;<br><a href="http://"><span class="echo-streamserver-bundledapps-stream-item-clientwidget-tag">asd</span></a>&nbsp;<br><a href="http://ya.ru">http://ya.ru</a>&nbsp;<br>&nbsp;<br><a href="http://google.com/#qwerty">http://google.com/#qwerty</a>'
			}, {
	...
	suite.prototype._runBodyCases = function(cases) {
		...
		var checker = function(params, config) {
			var element = $(".echo-streamserver-bundledapps-stream-item-clientwidget-body", config.target);
			var target = element.find(".echo-streamserver-bundledapps-stream-item-clientwidget-text");
	...
	suite._itemData = {
		...
		"actor": {
			...
			"title": "Somebody",
			"status": "Untouched",
			"avatar": Echo.require.toUrl("echo-assets/images/info70.png", false)
		},
		"object": {
	...
	Echo.Tests.defineComponentInitializer("Echo.StreamServer.BundledApps.Stream.Item.ClientWidget", function(config) {
		var stream = Echo.Tests.getComponentInitializer("Echo.StreamServer.BundledApps.Stream.ClientWidget");
