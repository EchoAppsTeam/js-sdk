Ext.data.JsonP.Echo_StreamServer_Controls_Submit_Plugins_TextCounter({
  ...
  "short_doc": "Adds the character counter under the text field in the Echo Submit control. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
