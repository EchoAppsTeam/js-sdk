Ext.data.JsonP.Echo_StreamServer_Controls_Submit_Plugins_JanrainAuth({
  "tagname": "class",
  ...
  "files": [
    {
      "filename": "janrain-auth.js",
      "href": "janrain-auth.html#Echo-StreamServer-Controls-Submit-Plugins-JanrainAuth"
    }
  ],
  "extends": "Echo.Plugin",
  "package": [
  ...
  "members": [
    {
      "name": "appId",
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.Submit.Plugins.JanrainAuth",
      "id": "cfg-appId",
      "meta": {
        "required": true
      }
    ...
    {
      "name": "forcedLoginMessage",
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Submit.Plugins.JanrainAuth",
      "id": "echo_renderer-forcedLoginMessage",
      "meta": {
      }
    }
  ],
  ...
  "id": "class-Echo.StreamServer.Controls.Submit.Plugins.JanrainAuth",
  "short_doc": "Janrain Social Sign-in Widget integration with Echo Submit Control. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
