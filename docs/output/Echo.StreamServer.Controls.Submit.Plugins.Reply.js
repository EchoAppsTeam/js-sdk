Ext.data.JsonP.Echo_StreamServer_Controls_Submit_Plugins_Reply({
  ...
  "short_doc": "Adds internal data field \"inReplyTo\" for correct reply workflow. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
