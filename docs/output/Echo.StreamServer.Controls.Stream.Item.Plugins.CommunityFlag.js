Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_Plugins_CommunityFlag({
  ...
  "members": [
    ...
    },
    {
      ...
      "tagname": "echo_label",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.CommunityFlag",
      "id": "echo_label-unflagProcessing",
      "meta": {
      }
    },
    {
    ...
    },
    {
      ...
      "tagname": "echo_event",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.CommunityFlag",
      "id": "echo_event-onUnflagComplete",
      "meta": {
      }
    },
    {
  ...
  "short_doc": "Adds extra Flag/Unflag buttons to each item in the Echo Stream\ncontrol for the authenticated users. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
