Ext.data.JsonP.Echo_StreamServer_API_Request({
  ...
  "short_doc": "Class implements the interaction with the\nEcho StreamServer API. ...",
  "component": false,
  "superclasses": [
    "Echo.API.Request"
  ],
