Ext.data.JsonP.Echo_StreamServer_Controls_Submit_Plugins_Edit({
  "tagname": "class",
  ...
  "files": [
    {
      "filename": "edit.js",
      "href": "edit.html#Echo-StreamServer-Controls-Submit-Plugins-Edit"
    }
  ],
  "extends": "Echo.Plugin",
  "private": true,
  ...
  "members": [
    ...
    },
    {
      ...
      "owner": "Echo.StreamServer.Controls.Submit.Plugins.Edit",
      "id": "echo_renderer-author",
      "meta": {
      }
    },
    {
    ...
    },
    {
      ...
      "tagname": "echo_event",
      "owner": "Echo.StreamServer.Controls.Submit.Plugins.Edit",
      "id": "echo_event-onEditInit",
      "meta": {
      }
    },
    {
      "name": "cancelButtonContainer",
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Submit.Plugins.Edit",
      "id": "echo_renderer-cancelButtonContainer",
      "meta": {
      }
    },
    {
  ...
  "id": "class-Echo.StreamServer.Controls.Submit.Plugins.Edit",
  "short_doc": "Adds new mode to the Echo Submit control which allows\nto edit the content and some metadata of the item. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
