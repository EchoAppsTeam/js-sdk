Ext.data.JsonP.Echo_Plugin({
  ...
  "short_doc": "Foundation class implementing core logic to create plugins and manipulate with them. ...",
  "component": false,
  "superclasses": [

  ],
  "subclasses": [
    "Echo.IdentityServer.Controls.Auth.Plugins.JanrainConnector",
    ...
    "Echo.StreamServer.Controls.Stream.Item.Plugins.JanrainSharing",
    ...
    "Echo.StreamServer.Controls.Stream.Item.Plugins.PinboardVisualization",
    "Echo.StreamServer.Controls.Stream.Item.Plugins.Reply",
    "Echo.StreamServer.Controls.Stream.Item.Plugins.TweetDisplay",
    "Echo.StreamServer.Controls.Stream.Item.Plugins.TwitterIntents",
    "Echo.StreamServer.Controls.Stream.Plugins.PinboardVisualization",
    ...
    "Echo.StreamServer.Controls.Submit.Plugins.JanrainAuth",
