Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_Plugins_Edit({
  ...
  "short_doc": "Adds extra “Edit” button to each item in the Echo Stream control\nwhich allows to edit the content and some metadata o...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
