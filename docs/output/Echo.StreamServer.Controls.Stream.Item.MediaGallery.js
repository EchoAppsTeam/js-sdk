Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_MediaGallery({
  "tagname": "class",
  ...
  "files": [
    {
      ...
      "href": "pinboard-visualization.html#Echo-StreamServer-Controls-Stream-Item-MediaGallery"
    }
  ],
  ...
  "members": [
    ...
    },
    {
      "name": "resizeDuration",
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.Stream.Item.MediaGallery",
      "id": "cfg-resizeDuration",
      "meta": {
      }
    },
    {
    ...
    },
    {
      ...
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Stream.Item.MediaGallery",
      "id": "echo_renderer-items",
      "meta": {
      }
    },
    {
      "name": "itemErrorLoading",
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Stream.Item.MediaGallery",
      "id": "echo_renderer-itemErrorLoading",
      "meta": {
      }
    }
  ],
  ...
  "id": "class-Echo.StreamServer.Controls.Stream.Item.MediaGallery",
  "component": false,
  "superclasses": [
    "Echo.Control"
  ],
