Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_Plugins_ItemAccumulatorDisplay({
  ...
  "members": [
    ...
    },
    {
      ...
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.ItemAccumulatorDisplay",
      "id": "echo_renderer-accumulatorContainer",
      "meta": {
      }
    }
  ],
  ...
  "short_doc": "Shows one of the item accumulators in the top right corner of each item in\nthe Echo Stream control. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
