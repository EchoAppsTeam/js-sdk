Ext.data.JsonP.Echo_IdentityServer_Controls_Auth({
  ...
  "package": [
    "identityserver/controls.pack.js",
  ...
  "members": [
    ...
    },
    {
      ...
      "tagname": "echo_renderer",
      "owner": "Echo.IdentityServer.Controls.Auth",
      "id": "echo_renderer-userAnonymous",
      "meta": {
      }
    },
    {
  ...
  "short_doc": "Echo Auth control displays the user login status and allows them to sign in using different social identities. ...",
  "component": false,
  "superclasses": [
    "Echo.Control"
  ],
