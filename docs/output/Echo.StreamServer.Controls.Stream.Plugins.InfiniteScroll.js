Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Plugins_InfiniteScroll({
  ...
  "short_doc": "Echo Stream plugin automatically loads the next page full of items\nwhen the end of the stream is displayed in the bro...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
