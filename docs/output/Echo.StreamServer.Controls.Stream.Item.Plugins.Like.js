Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_Plugins_Like({
  "tagname": "class",
  ...
  "files": [
    {
      "filename": "like.js",
      "href": "like.html#Echo-StreamServer-Controls-Stream-Item-Plugins-Like"
    }
  ],
  "extends": "Echo.Plugin",
  "package": [
  ...
  "members": [
    {
      ...
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Like",
      "id": "cfg-asyncFacePileRendering",
      "meta": {
      }
    },
    {
    ...
    },
    {
      ...
      "tagname": "echo_label",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Like",
      "id": "echo_label-unlikeProcessing",
      "meta": {
      }
    },
    {
    ...
    },
    {
      ...
      "tagname": "echo_event",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Like",
      "id": "echo_event-onUnlikeComplete",
      "meta": {
      }
    },
    {
  ...
  "id": "class-Echo.StreamServer.Controls.Stream.Item.Plugins.Like",
  "short_doc": "Adds extra Like/Unlike buttons to each item in the Echo Stream\ncontrol for authenticated users. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
