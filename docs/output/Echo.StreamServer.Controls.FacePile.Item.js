Ext.data.JsonP.Echo_StreamServer_Controls_FacePile_Item({
  "tagname": "class",
  ...
  "files": [
    {
      ...
      "href": "facepile.html#Echo-StreamServer-Controls-FacePile-Item"
    }
  ],
  ...
  "members": [
    ...
    },
    {
      "name": "infoMessages",
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.FacePile.Item",
      "id": "cfg-infoMessages",
      "meta": {
      }
    },
  ...
  "id": "class-Echo.StreamServer.Controls.FacePile.Item",
  "component": false,
  "superclasses": [
    "Echo.Control"
  ],
