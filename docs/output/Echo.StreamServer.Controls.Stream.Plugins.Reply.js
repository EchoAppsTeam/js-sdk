Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Plugins_Reply({
  ...
  "short_doc": "Proxies the \"Echo.StreamServer.Controls.Stream.Item.Plugins.Reply.onExpand\"\nevent on the Stream control level. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
