Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Plugins_PinboardVisualization({
  "tagname": "class",
  "files": [
    {
      "filename": "pinboard-visualization.js",
      "href": "pinboard-visualization.html#Echo-StreamServer-Controls-Stream-Plugins-PinboardVisualization"
    }
  ],
  "aliases": {
  },
  ...
  "members": [
    {
      "name": "isotope",
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.Stream.Plugins.PinboardVisualization",
      "id": "cfg-isotope",
      "meta": {
      }
    },
  ...
  "id": "class-Echo.StreamServer.Controls.Stream.Plugins.PinboardVisualization",
  "short_doc": "The PinboardVisualization plugin transforms Echo Stream Client visualization\ninto a pinboard-style representation. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
