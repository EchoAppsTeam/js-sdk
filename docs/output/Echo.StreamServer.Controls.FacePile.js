Ext.data.JsonP.Echo_StreamServer_Controls_FacePile({
  ...
  "short_doc": "Echo FacePile control displays users (actors) returned in any activity stream and displays a live updating collection...",
  "component": false,
  "superclasses": [
    "Echo.Control"
  ],
