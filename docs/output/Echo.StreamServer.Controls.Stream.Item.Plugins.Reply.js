Ext.data.JsonP.Echo_StreamServer_Controls_Stream_Item_Plugins_Reply({
  "tagname": "class",
  ...
  "files": [
    {
      "filename": "reply.js",
      "href": "reply.html#Echo-StreamServer-Controls-Stream-Item-Plugins-Reply"
    }
  ],
  "extends": "Echo.Plugin",
  "package": [
  ...
  "members": [
    {
      "name": "actionString",
      "tagname": "cfg",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Reply",
      "id": "cfg-actionString",
      "meta": {
      }
    },
    ...
    },
    {
      ...
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Reply",
      "id": "echo_renderer-compactContent",
      "meta": {
      }
    },
    {
      ...
      "tagname": "echo_renderer",
      "owner": "Echo.StreamServer.Controls.Stream.Item.Plugins.Reply",
      "id": "echo_renderer-compactBorder",
      "meta": {
      }
    }
  ],
  ...
  "id": "class-Echo.StreamServer.Controls.Stream.Item.Plugins.Reply",
  "short_doc": "Adds extra \"Reply\" button to each item in the Echo Stream control. ...",
  "component": false,
  "superclasses": [
    "Echo.Plugin"
  ],
