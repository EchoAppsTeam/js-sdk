define("echo/streamserver/controls/item", [
	"jquery",
	"echo/control",
	"echo/utils"
 ...
 */
var item = Control.manifest("Echo.StreamServer.Controls.Stream.Item");
...
define("echo/streamserver/controls/stream", [
	"jquery",
	"echo/control",
	"echo/streamserver/api",
	"echo/streamserver/controls/item",
	"echo/utils"
], function($, Control, API, Item, utils) {
 ...
 *
 * 	var stream = new StreamServer.Controls.Stream({
 ...
 * Configuration options
 */
var stream = Control.manifest("Echo.StreamServer.Controls.Stream");
