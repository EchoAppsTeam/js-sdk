...
stream.css =
	...
	'.{class:message-empty} { background-image: url({config:cdnBaseURL.sdk}/images/information.png); }' +
	'.{class:message-loading} { background-image: url({config:cdnBaseURL.sdk}/images/loading.gif); }' +
	'.{class:message-error} { background-image: url({config:cdnBaseURL.sdk}/images/warning.gif); }' +
	...
	'.{class:state-picture-paused} { background: url({config:cdnBaseURL.sdk}/images/control_pause.png) no-repeat center center; }' +
	'.{class:state-picture-live} { background: url({config:cdnBaseURL.sdk}/images/control_play.png) no-repeat center center; }' +
...
item.methods._initSmileysConfig = function() {
	...
	_smileys.tag = function(smiley) {
		return self.substitute({"template": '<img class="' + self.cssPrefix + 'smiley-icon" src="{config:cdnBaseURL.sdk}/images/smileys/emoticon_"' + smiley.file + '" title="' + smiley.title + '" alt="' + smiley.title + '" />'});
	};
	return _smileys;
};
...
item.css =
	...
	'.{class:markers} { line-height: 16px; background: url("{config:cdnBaseURL.sdk}/images/curation/metadata/marker.png") no-repeat; padding: 0px 0px 4px 21px; margin-top: 7px; }' +
	'.{class:tags} { line-height: 16px; background: url("{config:cdnBaseURL.sdk}/images/tag_blue.png") no-repeat; padding: 0px 0px 4px 21px; }' +
	...
	'.{class:metadata-userID} .{class:metadata-icon} { background: url("{config:cdnBaseURL.sdk}/images/curation/metadata/user.png") no-repeat left center; }' +
	'.{class:metadata-userIP} { border-bottom: 1px solid #e1e1e1; }' +
	'.{class:metadata-userIP} .{class:metadata-icon} { background: url("{config:cdnBaseURL.sdk}/images/curation/metadata/computer.png") no-repeat left center; }' +
	'.{class:modeSwitch} { float: right; width: 16px; height: 16px; background:url("{config:cdnBaseURL.sdk}/images/curation/metadata/flip.png") no-repeat 0px 3px; }' +
	...
	'.{class:tag} { display: inline-block; height: 16px; background: url("{config:cdnBaseURL.sdk}/images/tag_blue.png") no-repeat; padding-left: 18px; }' +
	...
	'.{class:expandChildren} .echo-message-icon { background: url("{config:cdnBaseURL.sdk}/images/whirlpool.png") no-repeat 5px 4px; }' +
	'.{class:expandChildren} .{class:message-loading} { background: no-repeat left top url("{config:cdnBaseURL.sdk}/images/loading.gif"); }' +
