...
if (Echo.AppServer.Dashboard.isDefined("Echo.Apps.SDKControls.Auth.Dashboard")) return;

var dashboard = Echo.AppServer.Dashboard.manifest("Echo.Apps.SDKControls.Auth.Dashboard");
