...
if (Echo.AppServer.Dashboard.isDefined("Echo.Apps.SDKControls.FacePile.Dashboard")) return;

var dashboard = Echo.AppServer.Dashboard.manifest("Echo.Apps.SDKControls.FacePile.Dashboard");
