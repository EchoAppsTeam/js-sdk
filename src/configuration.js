 ...
 * @param {Function} normalizer (optional) Function which is applied for every field value. You can use this function if any additional processing of the config field value is required.
 * @return {Object} Returns the reference to the given Echo.Configuration class instance.
 */
 ...
 * 
 * @param {Object} extra The corresponding value which should be defined for the key.
 * @method
 */
